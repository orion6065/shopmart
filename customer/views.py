...
def updateProfile(request):
    ...
    if request.method == "POST":
        ...
        # Updating firstname, lastname, and email into User model (auth_user)
...
def order_summary(request):
    ...
    # Attempt to get the profile address
    address = Profile.objects.filter(user_id=request.user.id).first()
